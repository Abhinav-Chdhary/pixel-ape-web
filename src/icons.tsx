...
export const MoveIcon = (props: Props) => <svg {...base} {...props}><path d="m13 3 4 4-1.4 1.4-1.6-1.6V11h4.2l-1.6-1.6L18 8l4 4-4 4-1.4-1.4 1.6-1.6H14v4.2l1.6-1.6L17 14l-4 4-4-4 1.4-1.4 1.6 1.6V10H7.8l1.6 1.6L8 13l-4-4 4-4 1.4 1.4L7.8 8H12V3.8l-1.6 1.6L9 4z" /></svg>
